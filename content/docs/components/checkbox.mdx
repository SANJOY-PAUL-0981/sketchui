...
| `label` | `React.ReactNode` | - | Content displayed alongside the checkbox. |
| `shape` | `CheckboxShape` | `"square"` | Controls the shape of the checkbox. |
| `checkStyle` | `CheckStyle` | `"check"` | Controls the visual style of the check mark. |
| `variant` | `CheckboxVariant` | `"paper"` | Controls the color theme of the checkbox. |
| `size` | `CheckboxSize` | `"md"` | Controls the size of the checkbox. |
| `rotate` | `number` | `0` | Controls the rotation angle of the checkbox for a hand-drawn effect. |
| `borderColor` | `string` | `"#111"` | Sets the border color of the checkbox. |
| `checkedColor` | `string` | `"#111"` | Sets the color used when the checkbox is checked. |
| `uncheckedColor` | `string` | `"#fffbf2"` | Sets the color used when the checkbox is unchecked. |
| `roughOptions` | `RoughCheckboxOptions` | - | Custom RoughJS rendering configuration. |
| `className` | `string` | - | Additional classes applied to the checkbox wrapper. |
| `labelClassName` | `string` | - | Additional classes applied to the checkbox label. |

## Rough Options

The `roughOptions` prop allows you to customize the hand-drawn appearance of the checkbox.
